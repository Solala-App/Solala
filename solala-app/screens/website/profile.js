...

        {
            nameAndTitle: "Christoph Bendix, App Development Lead", image: <Image source={Christoph} style={{ width: RFValue(150), height: RFValue(140) }} />, redirect:
                <Components.ProfilePopUp name="CHRISTOPH" position="App Development Lead" skills="Java, React, JS, MySQL, Git"
                    ...
                    cards={[{ image: "", accolade: "Leadership", description: "I communicated with the PM our next steps while leading the Software Engineering branch of Solala. Delegated various development tasks to ensure we stayed on target for launch." },
                    { image: "", accolade: "Creativity", description: "I lead the full stack development of Solala, working with UI and Back-end alike to ensure a high quality and beautiful End User Experience." },
                    {
                        image: "", accolade: "Technical", description: "I contributed to a significant portion of Solala's code, working with tutorials and other resources to teach myself new skills sets where needed."
                    }]}
...

        {
            nameAndTitle: "Drew King, Research Lead", image: <Image source={Drew} style={{ width: RFValue(150), height: RFValue(140) }} />, redirect:
                <Components.ProfilePopUp name="Drew" position="Research Lead" skills="research, technical writing"
                    ...
                    profileImage={Drew}
                    cards={[{ image: "", accolade: "Research", description: "Solala is a data driven application. In order to prioritize development of the needed tools I lead the research needed that determined Solala's key features." },
                        { image: "", accolade: "Diversity", description: "I advocated for us to pause at stages of development and better ask how we could build Solala to be accessible and inclusive." },
                    {
                        image: "", accolade: "Data Analytics", description: "Following the Research phase of solala I monitored for bugs, user engagement, testing phases and more to determine the use and priorities of our product."
                    }]}
                />},
...

        {
            nameAndTitle: "Christopher Roy, UX/UI Developer Lead", image: <Image source={Christopher} style={{ width: RFValue(150), height: RFValue(140) }} />, redirect:
                <Components.ProfilePopUp name="Christopher" position="UX/UI Development Lead" skills="Java, Figma, React, SQL, UX Design"
                    ...
                    cards={[{ image: "", accolade: "UX Development", description: "I helped to brainstorm how our app would feel for the customer, my personal focus on our Calender page." },
                        { image: "", accolade: "Leadership", description: "I lead the team in UI Design in Figma. Through my leadership and communication I set achievable deadlines that help get our app off the ground." },
                    {
                        image: "", accolade: "Front or Back-End Development", description: "I implemented React or Node.js features and created connections to the Azure Cloud SQL Server where necessary."
                    }]}
                />},
...

        {
            nameAndTitle: "Navkiran Nijjar, Head of Marketing", image: <Image source={Placeholder} style={{ width: RFValue(150), height: RFValue(140) }} />, redirect:
                <Components.ProfilePopUp name="Navkiran" position="Head of Marketing" skills="Marketing"
                    ...
                    cards={[{ image: "", accolade: "Social Media", description: "I did cool stuff." },
                        { image: "", accolade: "Stuff", description: "more neat things" },
                    {
                        image: "", accolade: "Stuff", description: "The rougher the seas, the smoother we sail. Ahoy! If ye thinks he be ready to sail a beauty, ye better be willin’ to sink with her."
                    }]}
                />},
...

        {
            nameAndTitle: "Robert Selfe, Social and Emotional Research", image: <Image source={Robert} style={{ width: RFValue(150), height: RFValue(140) }} />, redirect:
                <Components.ProfilePopUp name="Robert" position="Social and Emotional Researcher" skills="Social Health, Research, Communications, Psychology"
                    ...
                    profileImage={Robert}
                    cards={[{ image: "", accolade: "Social Health", description: "I helped to oversee the social aspect of app development, encouraging researched based tools or designs to increase product engagement." },
                        { image: "", accolade: "Research", description: "Solala is a science based app. I contributed to finding resources for our research to ensure that Solala did what it set out to do in the best way possible." },
                    {
                        image: "", accolade: "Adaptability", description: "With my experience in social health I was able to point out accessibility concerns within the app and contribute to product testing."
                    }]}
                />},
...

        {
            nameAndTitle: "Edison Jacob Lueng, Software Engineer", image: <Image source={Edison} style={{ width: RFValue(150), height: RFValue(140) }} />, redirect:
                <Components.ProfilePopUp name="Edison" position="Software Engineer" skills="Java, React, JS, Git"
                    ...
                    profileImage={Edison}
                    cards={[{ image: "", accolade: "Communication", description: "I really excelled at working with the app development lead and PM to make sure I kept up with project demands." },
                        { image: "", accolade: "Front-End Development", description: "After Building the Login page in Figma I helped to code our UX features using React." },
                    {
                        image: "", accolade: "Back-End Development", description: "I implemented Node.js features and created connections to the Azure Cloud SQL Server where necessary."
                    }]}
                />},
...

        {
            nameAndTitle: "Hawa Ali Drammeh, UX and Software Engineer", image: <Image source={Placeholder} style={{ width: RFValue(150), height: RFValue(140) }} />, redirect:
                <Components.ProfilePopUp name="Hawa" position="Software Developer" skills="Java, Figma, Scrum and Agile, UX Design"
                    ...
                    profileImage={Placeholder}
                    cards={[{ image: "", accolade: "UX Development", description: "I helped to brainstorm how our app would feel for the customer, focusing on our ToDo list page." },
                        { image: "", accolade: "Team Player", description: "I found ways to keep everyone involved and to help everyone better communicate by building our Design Doc." },
                    {
                        image: "", accolade: "Front or Back-End Development", description: "I implemented React or Node.js features and created connections to the Azure Cloud SQL Server where necessary."
                    }]}
                />},
...

        {
            nameAndTitle: "Brian Tran, Software Engineer", image: <Image source={Placeholder} style={{ width: RFValue(150), height: RFValue(140) }} />, redirect:
                <Components.ProfilePopUp name="Brian" position="Software Developer" skills="HCI, Java, Figma, UX Design"
                    ...
                    profileImage={Placeholder}
                    cards={[{ image: "", accolade: "UX Development", description: "I helped to brainstorm how our app would feel for the customer." },
                        { image: "", accolade: "Front-End Development", description: "After Building the Login page in Figma I helped to code our UX features using React." },
                    {
                        image: "", accolade: "Front or Back-End Development", description: "I implemented React or Node.js features and created connections to the Azure Cloud SQL Server where necessary."
                    }]}
...

        {
            nameAndTitle: "Angela Lee, UX and Software Engineer", image: <Image source={Angela} style={{ width: RFValue(150), height: RFValue(140), }} />, redirect:
                <Components.ProfilePopUp name="Angela" position="Software Developer" skills="HCI, Java, Figma, UX Design"
                    ...
                    profileImage={Angela}
                    cards={[{ image: "", accolade: "UX Development", description: "I helped to brainstorm how our app would feel for the customer, focusing on our home page when you first open the app." },
                        { image: "", accolade: "Front-End Development", description: "After Building the Login page in Figma I helped to code our UX features using React." },
                    {
                        image: "", accolade: "Front or Back-End Development", description: "I implemented React or Node.js features and created connections to the Azure Cloud SQL Server where necessary."
                    }]}
...

        {
            nameAndTitle: "Kimia Nehchiri, UX and Software Engineer", image: <Image source={Kimia} style={{ width: RFValue(150), height: RFValue(140), }} />, redirect:
                <Components.ProfilePopUp name="Kimia" position="Software Developer" skills="Java, UX design"
                    ...
                    profileImage={Kimia}
                    cards={[{ image: "", accolade: "UX Development", description: "I helped to brainstorm how our app would feel for the customer, focusing on our login page." },
                        { image: "", accolade: "Front-End Development", description: "After Building the Login page in Figma I helped to code our UX features using React." },
                    {
                        image: "", accolade: "Back-End Development", description: "I implemented Node.js features and created connections to the Azure Cloud SQL Server where necessary."
                    }]}
