    ...
    return (
        <div id="menu">
            ...
            <div id="menu-header">
                ...
                <img id="add-button" src="https://cdn.discordapp.com/attachments/886880496200609802/996885184874037408/unknown.png" alt="add button"></img>
            </div>
            ...
            <img id="scroll-down" src="https://cdn.discordapp.com/attachments/886880496200609802/996881406523351153/unknown.png" alt="scroll down button"></img>
        </div>
    );
}
...
function Footer() {
    return (
        ...
        <div id="footer">
            <img src="https://cdn.discordapp.com/attachments/886880496200609802/996890493705265262/unknown.png" alt="Home button"></img>
            <img src="https://cdn.discordapp.com/attachments/886880496200609802/996890538110353438/unknown.png" alt="Calendar button"></img>
            <img src="https://cdn.discordapp.com/attachments/886880496200609802/996890590132310047/unknown.png" alt="TODO button"></img>
        </div>
